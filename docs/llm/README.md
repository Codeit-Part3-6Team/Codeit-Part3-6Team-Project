...
`docs/llm/`는 ChatGPT, Codex, Claude 같은 LLM 기반 작업자가 저장소를 빠르게 이해하고 일관된 방식으로 수정하도록 돕는 문서 모음입니다.
...
| GitHub 운영 문서 보강 | `docs/md/workflow/GITHUB_OPERATIONS.md` |
| 첫 주 태스크 정리 | `docs/md/workflow/FIRST_WEEK_KANBAN.md` |
...
- 운영 방식이나 첫 주 태스크가 바뀌면 `docs/md/workflow/` 문서와 함께 확인합니다.
