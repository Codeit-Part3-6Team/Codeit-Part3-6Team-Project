...
이 문서는 로컬 기본 RAG 노트북과 선택형 Colab 노트북이 팀원이 따라가기 쉬운 상태인지 확인하기 위한 기준입니다.
...
- 로컬 실행이 기본이고 Colab은 선택형 실행 환경이라는 차이를 이해할 수 있습니다.
...
- Colab이 기본 실행 환경이 아니라는 점을 첫 부분에 적습니다.
...
- 로컬 실행과 선택형 Colab 실행 중 어느 환경에서 실행 중인지 헷갈리지 않습니다.
