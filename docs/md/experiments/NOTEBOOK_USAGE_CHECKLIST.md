...
이 문서는 RAG 노트북이 팀원이 따라가기 쉬운 상태인지 확인하기 위한 기준입니다.
...
- VM에서 실행하는 사람이 바로 따라 할 수 있게 시작 셀을 둡니다.
- 데이터 파일은 Git에 올리지 않고 VM 공유 경로에 둔다고 설명합니다.
