...
기본 비교 대상은 `configs/experiments/rag/rag_smoke_keyword.yaml`와 `configs/experiments/rag/rag_smoke_test.yaml`입니다.
...
1. `configs/experiments/rag/rag_smoke_test.yaml` 작성
