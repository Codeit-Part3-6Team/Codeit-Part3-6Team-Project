...
일정 기준을 맞춘 뒤에는 이 문서를 열어 Issue, PR, Kanban, Daily Report를 어떤 약속으로 사용할지 합의합니다.
...
- `.github/ISSUE_TEMPLATE/`, `.github/DISCUSSION_TEMPLATE/`, `.github/pull_request_template.md`가 있습니다.
...
작성 양식은 GitHub Discussion의 `Daily Report` 카테고리와 `.github/DISCUSSION_TEMPLATE/daily-report.yml`을 기준으로 합니다.
Issue 기반 운영이 필요하면 `.github/ISSUE_TEMPLATE/daily_report.md`를 대신 사용할 수 있습니다.
