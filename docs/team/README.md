...
| 전체 아키텍처와 구조를 그림으로 이해하고 싶을 때 | [architecture_overview.md](architecture_overview.md) |
| Streamlit 화면에서 RAG 기능을 어떻게 호출해야 하는지 | [rag_frontend_contract.md](rag_frontend_contract.md) |
| 팀 발표·설명 자료가 필요할 때 | [presentation_guide.md](presentation_guide.md) |
