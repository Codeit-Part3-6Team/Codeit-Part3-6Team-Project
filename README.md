...
- [모듈 구조 설명 HTML](docs/html/overview/module_architecture.html)
- [모듈 구조 설명 Markdown](docs/md/overview/MODULE_ARCHITECTURE.md)
...
python scripts/run_rag_retrieve.py --config configs/rag/rag_smoke_test.yaml --project-root . --question "예산은 얼마야?"
python scripts/run_rag_chat.py --config configs/rag/rag_smoke_test.yaml --project-root . --question "예산은 얼마야?"
...
- [docs/md/overview/PIPELINE_OVERVIEW.md](docs/md/overview/PIPELINE_OVERVIEW.md): 전체 파이프라인 설명
- [docs/md/overview/PIPELINE_INFRA_CHECKLIST.md](docs/md/overview/PIPELINE_INFRA_CHECKLIST.md): 현재 구현된 인프라 기능 점검표
- [docs/md/rag/rag/RAG_PIPELINE_SPEC.md](docs/md/rag/rag/RAG_PIPELINE_SPEC.md): RAG 문서, chunk, 검색, 답변 계약
- [docs/md/overview/MODULE_ARCHITECTURE.md](docs/md/overview/MODULE_ARCHITECTURE.md): 모듈 구조와 실행 흐름
- [docs/md/experiments/experiments/EXPERIMENT_GUIDE.md](docs/md/experiments/experiments/EXPERIMENT_GUIDE.md): 실험 실행 가이드
- [docs/md/experiments/experiments/COLAB_GUIDE.md](docs/md/experiments/experiments/COLAB_GUIDE.md): Colab/Drive 기반 실험 가이드
- [docs/md/workflow/GIT_WORKFLOW.md](docs/md/workflow/GIT_WORKFLOW.md): 브랜치, 커밋, PR 운영 규칙
- [docs/md/kickoff/KICKOFF_GUIDE.md](docs/md/kickoff/KICKOFF_GUIDE.md): 킥오프 설명용 Markdown

공유용 HTML:

- [docs/html/overview/pipeline_explainer.html](docs/html/overview/pipeline_explainer.html): 비전공자도 이해하기 쉬운 파이프라인 설명 HTML
- [docs/html/overview/module_architecture.html](docs/html/overview/module_architecture.html): 팀원 설명용 HTML 구조 문서
- [docs/html/kickoff/kickoff.html](docs/html/kickoff/kickoff.html): 킥오프 설명용 HTML
- [docs/html/overview/PIPELINE_OVERVIEW.html](docs/html/overview/PIPELINE_OVERVIEW.html): Markdown 원본에서 변환한 전체 파이프라인 HTML
