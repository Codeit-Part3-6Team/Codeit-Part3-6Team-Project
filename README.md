# RAG 기반 RFP 문서 분석 시스템 — 입찰메이트

입찰 공고, 제안요청서(RFP), 긴 업무 문서에서 핵심 정보를 빠르게 추출하고, 답변과 근거 citation을 함께 제공하는 RAG 시스템입니다.

**비즈니스 시나리오**: 공공입찰 컨설팅 스타트업 '입찰메이트'의 엔지니어링 팀이 되어, 컨설턴트들이 수백 건의 RFP 문서에서 핵심 정보(예산, 자격, 일정)를 빠르게 파악할 수 있도록 사내 RAG 챗봇을 구축합니다.
...
## 팀 보고서 주소
[팀 보고서](https://github.com/Codeit-Part3-6Team/Codeit-Part3-6Team-Project/blob/main/reports/6%ED%8C%80_%EC%A4%91%EA%B8%89%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8_%EC%A2%85%ED%95%A9%EB%B3%B4%EA%B3%A0%EC%84%9C.pdf)
